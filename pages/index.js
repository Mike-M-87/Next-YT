...
export default function Home() {
  ...
  return (
    <>
      <main id="ytslist" className="container-fluid fh-100 overflow-auto bg-black text-light py-1">
        <Head>
          <title>NEXT YT</title>
          ...
          <meta
            ...
            content="Basic implementation of the yts.mx/api"
          />
        ...
        <div className="hstack justify-content-between py-3">
          ...
          <a
            href="https://github.com/Mike-M-87/Next-YT.git"
            target="_blank"
            rel="noreferrer"
          >
            <img
        ...
        <div className="hstack gap-3 align-items-center justify-content-between">
          <input
            className="bg-dark border-0 py-2 text-light form-control"
            type="text"
            placeholder="Search"
            onChange={(e) => {
        ...
        <div className="collapse" id="filters">
          <div className="d-flex justify-content-around gap-2 py-2 flex-wrap">
            <div>
              ...
              <select
                className="form-select  custom-scrollbar bg-dark border-0 text-light"
            ...
            <div>
              ...
              <select
                className="form-select border-0 bg-dark text-light"
            ...
            <div>
              ...
              <select
                className="form-select border-0 bg-dark text-light"
                onChange={(e) =>
                  handleChange("with_rt_ratings", e.target.value)
                }
              >
        ...
        <section className="mt-3">
          {loading ? (
              ...
              ({
                ...
                <div className="card my-2 rounded bg-dark" key={id}>
                  <div
                    ...
                    className="hstack gap-4 cursor-pointer align-items-center"
                  >
                    <div>
                      <img
                        className="rounded"
                    ...
                    <div className="p-3">
                      <div className="hstack gap-4 my-3">
                        ...
                        <a
                          ...
                          onClick={(e) => setTrailer(yt_trailer_code)}
                        >
                          Trailer
                        </a>
                        <a href={`/watch/${id}`} className="btn btn-secondary">
                          Watch
                        </a>
                      ...
                      <div className="d-flex flex-wrap justify-content-center gap-3">
                        {torrents.map(({ hash, url, quality }) => (
                          <a key={hash} className="btn btn-success" href={url}>
                            {quality}
                          </a>
                        ))}
                      </div>
            ...
            <h5 className="text-center py-5 my-5 text-danger">
              No Movies Found
            </h5>
          )}
        </section>
        ...
        <ul className="pagination justify-content-center py-4">
          <li className="page-item">
            <button
              className="page-link text-success bg-dark border-0"
              href="#"
              aria-label="Previous"
              onClick={(e) => handleChange("page", params.page - 1)}
          ...
          <li className="page-item active">
            <a className="page-link bg-success border-0" href="#">
              {params.page}
            </a>
          </li>
          <li className="page-item">
